...
export const fTApi1 = async (location) => {
  try {
    ...
    const response = await axios.get(`http://192.168.2.40:8080/getFTDetails/${location}`);
...
export const fTApi2 = async (location) => {
  try {
    ...
    const response = await axios.get(`http://192.168.2.40:8090/getGlOutput/${location}`);
    // With Axios, the response data is automatically parsed as JSON.
    const data = response.data; // This is your JSON data.
    return data;
  } catch (error) {
...
export const fTApi3 = async (location) => {
  try {
    ...
    const response = await axios.get(`http://192.168.2.40:8090/getPFOutput/${location}`);
    // With Axios, the response data is automatically parsed as JSON.
    const data = response.data; // This is your JSON data.
    return data;
  } catch (error) {
...
export const fTApi4 = async (location) => {
  try {
    const response = await axios.get('http://192.168.2.40:8090/bestDeals');
    // With Axios, the response data is automatically parsed as JSON.
    const data = response.data; // This is your JSON data.
    return data;
  } catch (error) {
